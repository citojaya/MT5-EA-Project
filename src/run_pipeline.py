...
RAW_INPUT_FILE = (
        ...
        Path("data/raw/ICMarketsAU-Demo") / f"{symbol}_bidask_{timeframe}_20260101_20261231.csv"
...
SCRIPTS = [
   ...
   ("src/python/support_resistance.py --start-date 2026-01-01 --end-date 2026-12-31"),
