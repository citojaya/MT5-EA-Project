...
RAW_INPUT_FILE = (
        ...
        Path("data/raw/ICMarketsAU-Demo") / f"{symbol}_bidask_{timeframe}_20250101_20251231.csv"
...
SCRIPTS = [
   ...
   ("src/data/download_history.py", symbol, timeframe, "2025-01-01", "2025-12-31 23:59", "--config-file", config_file), # download complete history
   ("src/features/build_features.py", symbol, timeframe, "2025-01-01", "2025-12-31 23:59", "--config-file", config_file), # create features for whole history
   ...
   ("src/backtest/backtest.py",symbol,timeframe,"2025-07-01","2025-12-30 23:59","--input-file",str(RAW_INPUT_FILE),"--config-file",config_file),
