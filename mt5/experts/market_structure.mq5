...
input int    InpProfitableExitBars = 24;              // Close profitable trades after this many candles
input double InpTakeProfitAtrMultiplier = 6.0;        // Take-profit distance in ATR
